  ...
  >
    <template #center>
      <div class="flex justify-between w-screen h-full px-3">
        ...
        >
          <PrimeButton
            :severity="route.path == item.route ? 'primary' : 'secondary'"
            text
          ...
          >
            <div class="flex flex-col justify-items-center items-center gap-1">
              ...
              <span
                class="text-xs"
                :class="route.name == item.route ? 'text-primary' : 'text-secondary'"
                >{{ $t(`${item.label}`) }}</span
              >
            </div>
          </PrimeButton>
